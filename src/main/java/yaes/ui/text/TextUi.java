...
public class TextUi {
    ...
    static InputStreamReader    isr               = new InputStreamReader(
                                                          System.in);
    ...
    /**
     * A function for aborting the program.
     * 
     * @param string
     */
     ...
     * @return
     */
    public static boolean confirm(String prompt, final boolean defaultChoice) {
     ...
     * @return
     */
    public static boolean inputBoolean(String prompt, boolean oldValue) {
        prompt = TextUi.processPrompt(prompt + " [" + oldValue + "]");
     ...
     * @return
     */
    public static Date inputDate(String prompt, final Date oldValue) {
    ...
    public static File inputDirectory(final String prompt) {
        ...
        while (true) {
            ...
            final String value = TextUi.menu(menuItems, null, prompt
            ...
            if (value.equals("HOME")) {
                currentDir = new File(java.lang.System.getProperty("user.home"));
                continue;
            }
     ...
     * @return
     */
    public static Double inputDouble(String prompt, final Double oldValue) {
        prompt = TextUi.processPrompt(prompt);
        if (oldValue != null) {
            TextUi.println(prompt + oldValue);
            TextUi.println("<ENTER> to keep the old value");
     ...
     * @return
     */
    public static File inputFile(String prompt, final boolean checkForExistence) {
        prompt = TextUi.processPrompt(prompt);
        while (true) {
            try {
                TextUi.writer.print(prompt);
    ...
    public static File inputFileWithNavigation(final String startDir,
        ...
        while (true) {
            ...
            menuItems.add("HOME");
            menuItems.add("CANCEL");
            final String value = TextUi.menu(menuItems, null, "Current dir is:"
     ...
     * @return
     */
    public static Integer inputInteger(String prompt, final Integer oldValue) {
        prompt = TextUi.processPrompt(prompt);
        if (oldValue != null) {
            TextUi.println(prompt + oldValue);
            TextUi.println("<ENTER> to keep the old value");
     ...
     * @return
     */
    public static String inputString(String prompt, final String oldValue) {
        prompt = TextUi.processPrompt(prompt);
        if (oldValue != null) {
            TextUi.println(prompt + oldValue);
    ...
    public static List<String> selectFromChoices(final List<String> oldList,
        ...
        while (true) {
            final List<String> currentChoices = TextUi.prepareChoices(
                    currentList, choices);
            final String prompt = "Current elements: " + currentList
                    + "\nChoice: ";
            final String choice = TextUi.menu(currentChoices, TextUi.DONE,
                    prompt);
     ...
     * @return
     */
    public static int tripleChoice(String prompt, final boolean defaultChoice) {
        prompt = TextUi.processQuestionPrompt(prompt);
        while (true) {
            if (defaultChoice) {
